      ...
      body: Column(
        children: [
          Container(
            ...
            child: Text(
              'Passe deine Mahlzeitenauswahl an',
            ...
            child: ListView(
              children: [
                _buildSwitchListTile(
                  'Glutenfrei',
                  'Nur glutenfreie Mahlzeiten anzeigen',
                  _glutenFree,
                  (newValue) {
                    setState(
                      () {
                ...
                _buildSwitchListTile(
                  'Laktosefrei',
                  'Nur laktosefreie Mahlzeiten anzeigen',
                  _lactoseFree,
                  (newValue) {
                    setState(
                      () {
                ...
                _buildSwitchListTile(
                  'Vegetarisch',
                  'Nur vegetarische Mahlzeiten anzeigen',
                  _vegetarian,
                  (newValue) {
                    setState(
                      () {
                ...
                _buildSwitchListTile(
                  'Vegan',
                  'Nur vegane Mahlzeiten anzeigen',
                  _vegan,
                  (newValue) {
                    setState(
                      () {
